        ...
        <div className=" min-h-screen fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label htmlFor="adminPassword" className="block text-sm font-medium text-gray-700">Mật khẩu</label>
                <input
                  type="password"
                  id="adminPassword"
                  name="adminPassword"
              ...
              <div className="mb-4">
                <label htmlFor="adminRole" className="block text-sm font-medium text-gray-700">Chọn Quyền</label>
                <select
                  id="adminRole"
                  name="adminRole"
                  value={adminRole}
